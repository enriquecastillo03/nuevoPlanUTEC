...
function doPropertiesTable(rows) {
    ...
    $(rows).each(function (index, element) {
        if(element.id !== false){
            table += '<tr>';
            table += '<td class="left">' + element.inm_address + '</td>';
            table += '<td class="left">' + element.inm_description + '</td>';
            table += '<td class="left">' + element.inm_levels + '</td>';
            table += '<td class="left">' + element.inm_cod + '</td>';
            table += '<td class="left">' + element.inm_zone + '</td>';
            table += '<td class="left">' + element.inm_use + '</td>';
