/*
Name: Flot Plugin For Creating Tooltips
By: Copyright 2012, Krzysztof Urbas
Web Site: (http://myviews.pl)
GitHub: (https://github.com/skeleton9/flot.tooltip)
...
(function ($) {
	var options = {
		...
		tooltipOpts: {
			...
			defaultTheme: true // styles for tooltip in style.css file ( #flot_tooltip )
		}
	};
	...
	var init = function(plot) {
		...
		plot.hooks.bindEvents.push(function (plot, eventHolder) {
			...
			if( $('#flot_tooltip').length > 0 ){
				$tip = $('#flot_tooltip');
			}
			else {
				$tip = $('<div />').attr('id', 'flot_tooltip');
