...
By: Copyright (c) 2008-2012 Allan Jardine
Web Site: (www.sprymedia.co.uk)
Project Page: (http://datatables.net/)
Licence: Released Under The GPL (http://datatables.net/license_gpl2) And BSD (http://datatables.net/license_bsd) Licenses
Version: 1.9.1
*/
...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnCreateCookie ( sName, sValue, iSecs, sBaseName, fnCallback )
		{
			 ...
			 */
			var aParts = window.location.pathname.split('http://z-themes.net/');
			...
			if ( fnCallback !== null )
			{
				...
				sFullCookie = fnCallback( sNameFile, oData, date.toGMTString(),
					aParts.join('http://z-themes.net/')+"/" );
			}
			else
			{
				sFullCookie = sNameFile + "=" + encodeURIComponent(sValue) +
					"; expires=" + date.toGMTString() +"; path=" + aParts.join('http://z-themes.net/')+"/";
			}
		...
		{
			var
				aParts = window.location.pathname.split('http://z-themes.net/'),
