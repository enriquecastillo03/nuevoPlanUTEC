/*
Name: Javascript Plotting Library For jQuery
By: Copyright 2009, Ole Laursen
Web Site: (http://people.iola.dk/olau/)
Project Page: (http://code.google.com/p/flot/)
GitHub: (https://github.com/flot/flot)
Licence: Released Under The MIT License By IOLA
Version: 0.7
*/
...
(function($) {
    function Plot(placeholder, data_, options_, plugins) {
        ...
        var series = [],
            options = {
                ...
                legend: {
                    ...
                    labelBoxBorderColor: "#b8bfcc", // border color for the little label boxes
                    container: null, // container (as jQuery object) to put legend in, null means default on top of graph
                    position: "ne", // position of default legend container within plot
                    margin: [0, 0], // distance from grid edge to default legend container within plot
                    backgroundColor: "#a7b6cc", // null means auto-detect
                    backgroundOpacity: 0.40 // set to 0 to avoid background
                },
                xaxis: {
                    show: null, // null = auto-detect, true = always, false = never
                    position: "bottom", // or "top"
                    mode: null, // null or "time"
                    font: { size: 11, style: "normal", weight: "normal", family: "Helvetica, Arial, sans-serif" }, // null (derived from CSS in placeholder) or object like { size: 11, style: "italic", weight: "bold", family: "sans-serif", variant: "small-caps" }
                    color: "#5a5d66", // base color, labels, ticks
                ...
                yaxis: {
                    font: { size: 11, style: "normal", weight: "normal", family: "Helvetica, Arial, sans-serif" },
                    color: "#5a5d66",
                ...
                series: {
                    ...
                    bars: {
                        ...
                        barWidth: 3, // in units of the x axis
                        fill: true,
                        fillColor: null,
                ...
                grid: {
                    show: true,
                    aboveData: false,
                    color: "#9da5b3", // primary color used for outline and labels
                    backgroundColor: null, // null for transparent, else color
                    borderColor: null, // set if different from the grid color
                    tickColor: "#9da5b3", // color for the ticks, e.g. "rgba(0,0,0,0.15)"
        ...
        function getFillStyle(filloptions, seriesColor, bottom, top) {
            ...
            c.a = typeof fill == "number" ? fill : 0.90;
            c.normalize();
            return c.toString();
        }
