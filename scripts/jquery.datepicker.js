/*
Name: glDatePicker - A simple, customizable, lightweight date picker calendar plugin for jQuery
By: Copyright (c) 2011 Gautam Lad
Web Site: (http://gautamlad.com/)
Project Page: (http://code.gautamlad.com/glDatePicker/)
GitHub: (https://github.com/glad/glDatePicker/)
Licence: Released under the MIT licence (http://www.opensource.org/licenses/mit-license.php)
Version: 1.3
*/
	...
	var methods =
	{
		...
		update:function()
		{
			...
			if($("#"+calId).length == 0)
			{
				target.after
				(
					$('<div class="datepicker" id="'+calId+'"></div>')
				);
			}

			// Show calendar
			var calendar = $("#"+calId);
			calendar.html(html).slideDown(20);
