...
class Tank_auth
{
	 ...
	 * @return	array
	 */
	function create_user($username=null, $email, $password, $email_activation, $rol=null, $nombre1=null,$nombre2=null,$apellido1=null,$apellido2=null, $edad=null, $aula=null,$numero_factura=null,$concepto_factura=null, $fecha_factura=null)
	{
		...
		if ((strlen($username) > 0) AND !$this->ci->users->is_username_available($username)) {
			...
			if ($email_activation) {
				...
				//$this->db->insert("alm_alumno", $array_alumno);
		
			if (!is_null($res = $this->ci->users->create_user($data, !$email_activation, $rol, $nombre1,$nombre2,$apellido1,$apellido2, $edad, $aula, $password, $numero_factura, $concepto_factura, $fecha_factura))) {
				$data['user_id'] = $res['user_id'];
				$data['password'] = $password;

				unset($data['last_ip']);
				// $this->ci->session->set_flashdata('usuario_creado','1');
	...
	function create_alumno($username=null, $email, $password, $email_activation, $rol=null, $nombre1=null,$nombre2=null,$apellido1=null,$apellido2=null, $edad=null, $aula=null,$numero_factura=null,$concepto_factura=null, $fecha_factura=null)
	{
		...
		if ((strlen($username) > 0) AND !$this->ci->users->is_username_available($username)) {
			...
			if (!is_null($res = $this->ci->users->create_alumno($data, !$email_activation, $rol, $nombre1,$nombre2,$apellido1,$apellido2, $edad, $aula, $password, $numero_factura, $concepto_factura, $fecha_factura))) {
				$data['user_id'] = $res['user_id'];
				$data['password'] = $password;
